...
import { foematMessageTime } from '../lib/utils.js'
const ChatContainer = ({selectedUser, setSelectedUser}) => {
  ...
  return selectedUser ?  (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      <div className='flex flex-col h-[calc(100%-120px)] overflow-scroll p-3 pb-6'>
        {messagesDummyData.map((msg, index) => (
            ...
            senderId !== '680f5116f10f3cd28382ed02' && 'flex-row-reverse'}`}>
                {msg.image ? (
                    ...
                    senderId !== '680f5116f10f3cd28382ed02' ? 'rounded-br-none' : 'rounded-bl-none'}`}>{msg.text}</p>
                )}
                <div className='text-center text-xs'>
                    <img src={msg.senderId === '680f5116f10f3cd28382ed02' ? assets.
                    avatar_icon : assets.profile_martin
                    } alt="" className='w-7 rounded-full'/>
                    <p className='text-gray-500'>{foematMessageTime(msg.createdAt)}
    ...
    {/* Bottom Area */}
    <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'></div>
        <div>
