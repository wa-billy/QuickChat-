...
const Sidebar = () => {
    ...
    const filterUsers = input ? users.filter((user) => user.fullName.toLowerCase().include(input.toLowerCase()))
    : users
  ...
  return (
    ...
    text-white ${selectedUser ? 'max-md:hidden' : ''}`}>
      <div className='pb-5'>
        ...
        <div className='bg-[#282142] rounded-full flex items-center gap-4 py-3 px-4 
        mt-5'>
